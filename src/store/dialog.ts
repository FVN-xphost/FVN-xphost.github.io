...
export const dialogChapter0 = readable<DialogInterface[]>([
  ...
  Aside("你深吸一口气，从头开始告诉托尼，关于那枚蛋，关于船票……（除了你像野兽的那段）"),
  Tony("那可能是一个礼品盒。"),
  Aside("托尼的指示灯闪烁着。"),
  ...
  Tony("去他的工作吧！这都什么时候，你还在想这种事，那可是地球！那才是人应该生活的地方，空气、水、食物都是天然的，到处都是，你大可以等到了地球再考虑这种事！", [{ key: "branch3", value: "可是，到地球我能做什么呢？我的工作怎么办？" }]),
  Choice(
    "branch4",
